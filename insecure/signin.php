		...
		<div class="main-content gradient-bg">
			...
			<div class="l-part">
				<form action="" method="post">
					<input type="text" name="email" placeholder="Email" required="required" class="form-control input-md"><br>
					...
					<a style="text-decoration: none;float: right;color: #00CED1;" data-toggle="tooltip" title="Create Account!" href="signup.php">Don't have an account?</a><br><br>
