...
<div class="row">
	...
	<div class="col-sm-10">
		<?php
			...
			<div id='profile-img'>
				<img src='users/$user_image' alt='Profile' class='img-circle' width='150px' height='150px'><br><br>
				<form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'>
                
                <label class='btn site-btn sb-gradients' id='update_profile'> Select Profile
							<input type='file' name='u_cover' size='40' />
							</label>
                
				<button id='button_profile' name='update' class='btn site-btn sb-gradients'>Update Profile</button>
				</form>
			</div><br>
			";
		?>
