...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		values('$first_name','$last_name','$username','Still thinking about it!','Unavailable','$hashed','$email','$country','$gender','$birthday','$profile_pic','default_image.jpeg',NOW(),'$status','$posts','Nobody')";
